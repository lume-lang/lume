...
module Lume
  class Compiler
    ...
    class Builder
      ...
      # Gets the current branch exit block.
      #
      # @return [LLVM::BasicBlock] The current branch exit block.
      def exit_block
        @branch_exit
      end

      # Enters a new branch with the given block.
      #
      # @param block [LLVM::BasicBlock] The block to enter.
      #
      # @return [void]
      def enter_branch(block)
        @branch_exit = block
      end
